...
class Ruleset_combat_config_modal(discord.ui.Modal):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        #### Test movement formula
            ...
            msg = "The value entered into the Movement formula field is incorrect"
            await interaction.response.send_message(msg, ephemeral=True)
        #### Placeholder
        #### Test initiative formula
        elif True == False:
            msg = "The value entered into the Initiative formula field is incorrect"
            await interaction.response.send_message(msg, ephemeral=True)
        else:
            document = {
                ...
                "default_equipment" : self.ruleset["default_equipment"],
